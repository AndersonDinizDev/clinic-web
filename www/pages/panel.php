...
<body id="body-pd">
  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div> <a href="#" class="nav_logo"> <img class='nav_logo-icon' src="../assets/logo.svg" alt="logo-img"></img> <span class="nav_logo-name">Menu</span> </a>
  ...
  <footer class="w-100 pt-3">
    <p class="text-center texts-type-7" style="opacity: 30%;">© Web Cursos <?php echo date("Y") ?></p>
  </footer>
